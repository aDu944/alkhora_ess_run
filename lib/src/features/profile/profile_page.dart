...
final employeeProfileProvider = FutureProvider<Map<String, dynamic>>((ref) async {
  ...
  return empRepo.getEmployeeProfile(employeeId);
});
            ...
            children: [
              ...
              if (data['date_of_joining'] != null)
                _InfoCard(
                  ...
                  value: _formatDate(data['date_of_joining'] as String),
                ),
        ...
        error: (err, _) => Center(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              Text('Error loading profile', style: TextStyle(color: Colors.red[700])),
